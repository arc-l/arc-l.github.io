...
induced by synchronous robot motions. For example, the figure to the right <a href="/media/fig-8.png" target="_"><img src="/media/fig-8.png" width="250" border="0" align="right" title="click for a more readable version"/></a> illustrates how the locations of two robots ($c_2$ and $c_5$) may be exchanged on a cycle using a limited number of moves. For more details, see <a href="/files/YuRus15STAR.pdf" target="_">this paper</a>. <br/>
